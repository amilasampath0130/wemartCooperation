  ...
  return (
    <div className="w-full bg-whiteText md:sticky md:top-0 z-50">
      ...
      <div className="w-full bg-darkText text-whiteText">
        ...
        <Menu>
          ...
          {bottomNavigation.map(({ title, link }) => (
            <Link
              to={link}
              key={title}
              className=" items-center content-end mx-6 uppercase hidden md:inline-flex text-sm font-semibold text-whiteText/90 hover:text-whiteText duration-200 relative overflow-hidden group "
            >
              {title}
        ...
        {/* Mobile Navigation */}
        {isNavOpen && (
          <div className="md:hidden flex flex-col items-center bg-black/90 text-whiteText py-3">
            {bottomNavigation.map(({ title, link }) => (
              <Link
                to={link}
                key={title}
                className="py-2 text-sm font-semibold hover:text-white duration-200"
